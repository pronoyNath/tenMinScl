...
const Title = ({ courseData }: { courseData: any }) => {
  ...
  return (
    ...
    >
      ...
      <div className="container px-20 py-5 relative z-10  max-w-3xl  space-y-4">
        <h1 className="font-fontTwo text-3xl md:text-4xl font-bold">{courseData?.title}</h1>
       <div className="flex items-center gap-2">
         <img
        src="https://cdn.10minuteschool.com/images/Dev_Handoff_Q1_24_Frame_2_1725444418666.png" alt="" />
